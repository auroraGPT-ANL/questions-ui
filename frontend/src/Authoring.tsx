...
export function QuestionsInstructions() {
        return (<div>
            ...
            <ul>
                ...
                <li>Avoid questions that require interpretation of figures or tables as our ability to extract these is limited.</li>
        ...
        <Container>
            ...
            <Grid>
                ...
                <NativeSelect
                    ...
                    data={
                        difficulty ? 
                        allowedDifficulties.map(diff => ({ value: diff, label: diff })) : 
                        [
